        ...
        <div className="flex flex-col items-center gap-8 sm:gap-12 xl:gap-16 w-[90%] sm:w-[93%]">
          <div className="text-center">
            ...
            <p className="font-madimi text-2xl md:text-[28px] lg:text-[32px] xl:text-[36px] 2xl:text-[50px] text-maroon max-w-[18.1em] !leading-[1.25] mt-3 slide-in-item">
              Welcome to the $FATHER realm, where loyalty is rewarded, and bravery honored. 
            </p>
          </div>

          <div className="flex flex-wrap justify-center gap-4">
            <Card>
              As we near a momentous milestone, we hereby summon valiant Bounty
              Hunters from our noble community! This grand quest offers the chance
              to win treasures in $SOL.
            </Card>
            <Card>
              Soon, we shall bestow gifts of $FATHER (or its weight in $SOL) upon
              the worthy. Once our system is in place, entry shall be granted by
              crafting a post—untouched by cash tags. Every week, we shall convene
              to draw forth the chosen from among ye.
            </Card>
            <Card>
              Starting on the 10th day of November, we shall host sacred Sunday
              Sermons every fortnight, and weekly gatherings throughout December.
              Join us in our Telegram hall, for some lost souls in attendance may
              find themselves blessed with $SOL for their loyalty.
            </Card>
          </div>
        </div>
      </div>
